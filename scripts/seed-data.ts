...
const productos = [
  ...
  },
  {
    ...
    slug: "fideos-caseros",
    descripcion: "Fideos frescos elaborados diariamente con sémola de grano duro y huevos de granja.",
    precio: 1800,
    categoria: "sin-relleno",
    subcategoria: "fideos",
    imagen: "https://images.unsplash.com/photo-1551183053-bf91a1d81141?w=400&h=300&fit=crop",
    ingredientes: ["Sémola de grano duro", "Huevos", "Aceite de oliva", "Sal"],
    disponible: true,
    destacado: false,
    orden: 6,
    porciones: 4,
