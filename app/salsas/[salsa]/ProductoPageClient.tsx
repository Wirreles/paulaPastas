...
// FAQs específicas para salsas
const faqs: Faq[] = [
  {
    question: "¿Cuánto rinden las salsas?",
    answer: "Cada salsa rinde aproximadamente 4-6 porciones, dependiendo de la cantidad que uses por plato. Son perfectas para acompañar nuestras pastas frescas.",
  },
  {
    question: "¿Cuánto duran en el freezer? ¿Y en la heladera?",
    answer: "Duran hasta 30 días en el freezer y 4 días en la heladera, siempre que se mantengan refrigeradas. Te recomendamos consumirlas dentro de estos plazos para mantener la mejor calidad.",
  },
  {
    question: "¿Vienen listas para usar o hay que calentarlas?",
    answer: "Vienen listas, solo necesitás calentarlas a baño maría o microondas antes de servir. No requieren preparación adicional, solo calentamiento.",
  },
  {
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: producto.nombre,
          item: `https://paulapastas.com/salsas/${productoSlug}`,
        },
      ],
    },
  }
        ...
        <div className="bg-white border-b border-neutral-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav className="flex items-center space-x-2 text-sm">
              ...
              <Link href="/pastas/salsas" className="text-neutral-500 hover:text-primary-600">
                Salsas
              </Link>
              <span className="text-neutral-400">/</span>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl overflow-hidden">
                <ImageWrapper
                  ...
                  priority={true}
                  fallback="/placeholder.svg?height=400&width=400&text=Salsa"
          ...
          <section className="mt-16 bg-white rounded-2xl shadow-lg p-8 text-center">
            <h2 className="font-display text-2xl font-bold text-neutral-900 mb-4">
              {producto.historiaPlato?.titulo || "Una salsa con historia, cocinada a fuego lento."}
            </h2>
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 text-neutral-700">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>Congeladas para conservar frescura</span>
              </div>
            </div>
          </section>
          ...
          {/* 6. ✅ NUEVA SECCIÓN: "¿Por qué nuestras salsas son diferentes?" */}
          <section className="mt-16 bg-white rounded-2xl shadow-lg p-8 text-center">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-neutral-900 mb-8">
              ¿Por qué nuestras salsas son diferentes?
            </h2>
            <div className="text-lg text-neutral-700 leading-relaxed max-w-4xl mx-auto space-y-6 text-left">
              <p>
                Porque no se trata solo de salsa.
              </p>
              <p>
                Cocinamos a fuego lento cada ingrediente como si fuera el plato principal: tomates maduros, cebollas caramelizadas, hierbas frescas y especias seleccionadas.
              </p>
              <p>
                Cada salsa está elaborada artesanalmente en Rosario, con ingredientes frescos y sin conservantes.
              </p>
              <p>
                Y lo mejor: en menos de 5 minutos, tenes una salsa que podrías servir en un restaurante... pero en tu casa.
              </p>
            </div>
          </section>
          ...
          <section className="mt-16 bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600">
                Resolvemos las dudas más comunes sobre nuestras salsas caseras y el proceso de compra.
              </p>
            </div>
          ...
          {productosRelacionados.length > 0 && (
            <section className="mt-16">
              <h2 className="font-display text-3xl font-bold text-neutral-900 mb-8 text-center">
                Otras salsas que te pueden gustar
              </h2>
